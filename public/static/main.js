...
(function () {
  ...
  function closeMobileMenu() {
    ...
    document.querySelectorAll('.navbar__mobile-sub.open').forEach(function (sub) {
      sub.classList.remove('open');
    });
    document.querySelectorAll('.navbar__mobile-link--parent').forEach(function (btn) {
  ...
  document.querySelectorAll('.navbar__item--dropdown').forEach(function (item) {
    ...
    trigger.addEventListener('click', function (e) {
      ...
      document.querySelectorAll('.navbar__item--dropdown.open').forEach(function (el) {
        el.classList.remove('open');
        el.querySelector('.navbar__link--dropdown-trigger')?.setAttribute('aria-expanded', 'false');
      });
      if (!isOpen) {
  ...
  document.querySelectorAll('.navbar__mobile-link:not(.navbar__mobile-link--parent), .navbar__mobile-sublink').forEach(function (link) {
